...
public class UserController
{
	...
	public ResponseEntity<UserResponse> getUserById(@PathVariable("userId") String id) throws ApiException
	{
	...
	@PostMapping
	public ResponseEntity<UserResponse> postUser(@RequestBody UserRequest request, BindingResult bindingResult) throws ApiException
	{
	...
	public ResponseEntity<UserResponse> putUser(@RequestBody UserRequest request, @PathVariable("userId") String userId, BindingResult bindingResult) throws ApiException
	{
